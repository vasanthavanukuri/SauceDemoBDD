...
Scenario Outline: Login with ValidCredentials 
 ...
 Scenario: Adding products to cart  
    When  I click on add to cart button by entering login details from Excel "src/test/resources/Excel/sauceddemoexcel.xlsx" with SheetName "Login Valid Credentials" 
...
Scenario: Entering your Information 
	When  I enter userName as 'standard_user' and password as  'secret_sauce'  and firstName as 'vasantha' and lastname as 'vanukuri' and zipCode as '522612' 
	Then overView  page should be displayed 
	
Scenario: Placing an order 
	When  I enter userName as 'standard_user' and password as  'secret_sauce' and firstName as 'vasantha' and lastname as 'vanukuri' and zipCode as '522612'  and click on continue and then finish 
